...
class Smarty
{
     ...
     * @param array|null $allowed     list of allowed methods (empty = all)
     ...
     *
     * @param string|null $tpl_file   name of template file
     * @param string|null $cache_id name of cache_id
     * @param string|null $compile_id name of compile_id
     * @param string|null $exp_time   expiration time
     * @return bool
     */
     ...
     *
     * @param string|null $exp_time expire time
     ...
     *
     * @param string|null $tpl_file
     * @param string|null $compile_id
     * @param string|null $exp_time
     * @return bool results of {@link smarty_core_rm_auto()}
     */
    ...
    function _compile_source($resource_name, &$source_content, &$compiled_content, $cache_include_path = null)
    {
        ...
        if ($smarty_compiler->_cache_serial) {
            ...
            $this->_cache_include_info = ''; //mb TODO - Incompatible types: Expected property of type '#㈲\string|array|?', 'null' provided
        }
    ...
    function _get_compile_path($resource_name)
    {
        return $this->_get_auto_filename(
                $this->compile_dir, $resource_name,
                $this->_compile_id
            ) . '.php';
    }
     ...
     * @param string|null $auto_source
     * @param string|null $auto_id
     * @return string
     ...
     * @param string       $error_msg
     * @param string|null $tpl_file
     * @param integer|null $tpl_line
     * @param string|null  $file
     * @param integer|null $line
     * @param int      $error_type
     */
    function _trigger_fatal_error(
        $error_msg, $tpl_file = null, $tpl_line = null,
