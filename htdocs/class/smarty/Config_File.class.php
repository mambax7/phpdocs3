...
class Config_File {
     ...
     *
     * @param string|false $config_path path to the config files
     */
     ...
     * @return array|false an array of section names from the specified file
     */
     ...
     *
     * @param string|null $file_name file to clear config data for
     */
