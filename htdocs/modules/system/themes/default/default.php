...
//        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/default/js/tabs.jquery.tools.min.js');
        ...
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/default/css/dark.css', array(
            'title' => 'dark',
            'media' => 'screen',
        ));
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/default/css/silver.css', array(
            'title' => 'silver',
            'media' => 'screen',
        ));
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/default/css/orange.css', array(
            'title' => 'orange',
            'media' => 'screen',
        ));
